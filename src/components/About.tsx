...
const About: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'FSSAI & MSME registered for your peace of mind'
    },
    {
      icon: Users,
          ...
          <div className="space-y-8">
            ...
            <div className="prose prose-lg text-gray-600">
              <p>
                ...
                Today, we're proud to be FSSAI and MSME registered, ensuring quality and trust in every creation.
              </p>
            </div>
